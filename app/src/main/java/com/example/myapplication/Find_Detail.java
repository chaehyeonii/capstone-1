...
public class Find_Detail extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        id=getIntent().getStringExtra("TEXT");
        fdSn=getIntent().getStringExtra("fdSn");
    ...
    String getXmlData() {
        ...
        String queryUrl = "http://apis.data.go.kr/1320000/LosfundInfoInqireService/getLosfundDetailInfo?"//요청 URL
                +"serviceKey=" + key + "&ATC_ID="+id+ "&FD_SN="+fdSn;
        //String queryUrl = "http://apis.data.go.kr/1320000/LosfundInfoInqireService/getLosfundDetailInfo?serviceKey=%2Byy%2BAg9TKR9ECCv0yM0FkpCbZUyhIAsutQKN5U%2BzwQLeB6cWr1mrzLwH68caK39fPNG1YDiZGj3uv3AjFg6mVw%3D%3D&ATC_ID=F2018113000002322&FD_SN=1";
